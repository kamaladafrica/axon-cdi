...
import static it.kamaladafrica.cdi.axonframework.support.CdiUtils.findAnnotation;
import static it.kamaladafrica.cdi.axonframework.support.CdiUtils.isInheritMarker;
...
public class SagaInfo extends AxonConfigInfo {
	...
	private static Map<QualifierType, Set<Annotation>> extractQualifiers(BeanManager bm,
		...
		SagaConfiguration sagaConfiguration = findAnnotation(bm, annotated.getAnnotations(),
